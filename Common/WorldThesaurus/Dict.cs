...
namespace f
{
    public class D
    {
        ...
        {
            string fileName = @"dictionaries\WordNet\data" + fileNameTermination + ".tz";
...
//            "ar", //   noun 	person that does it 	beggar, liar 	Neutral
        ...
        public static Dictionary<string, IndexItem> Index = new Dictionary<string, IndexItem> { };
        ...
        public static Dictionary<string, IndexItemList<IndexItem>> SearchIndex = new Dictionary<string, IndexItemList<IndexItem>> { };

        public static void BuildIndex()
        {
            #region build rawSearchIndex = 549
            using (new Watcher("for idiom"))
            {                
            ...
            int midleSize = 300;
            using (new Watcher("детализация и сжатие"))
            {
